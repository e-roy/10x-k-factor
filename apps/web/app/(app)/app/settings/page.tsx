...
export default function ProfileSettingsPage() {
  ...
  const currentPrimaryColor =
    primaryColor ||
    getPersonaPrimaryColor(persona as "student" | "parent" | "tutor");
  const currentSecondaryColor =
    secondaryColor ||
    getPersonaSecondaryColor(persona as "student" | "parent" | "tutor");
      ...
      {persona === "student" && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select the subjects you&apos;re studying. These will appear in
              your dashboard and challenges.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {subjects.length === 0 && (
              <div className="text-center py-4 text-sm text-muted-foreground">
                No subjects selected. Select at least one subject to see
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              🔗 Admin: Preview persona theme system demo &gt;
            </Link>
          </div>
