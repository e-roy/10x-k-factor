...
- **Left sidebar** (sticky):
  ...
  - **Admin** (role-gated) `/app/admin/metrics`
  ...
  return (
    <div className="grid grid-cols-[260px_1fr] min-h-screen">
      <aside className="border-r bg-background p-4">
        <Link href="/app" className="font-semibold text-lg block mb-4">
          K-Factor
        </Link>
        ...
        <div className="mt-auto pt-4">
          {/* Sticky Invite CTA */}
          <button className="w-full rounded-2xl border px-3 py-2">
            Invite a friend
          </button>
        </div>
      </aside>
      <div className="flex flex-col">
        <header className="h-14 border-b flex items-center justify-between px-4">
          ...
          <div className="text-sm">
            Cohort: <strong>Algebra A</strong>
          </div>
